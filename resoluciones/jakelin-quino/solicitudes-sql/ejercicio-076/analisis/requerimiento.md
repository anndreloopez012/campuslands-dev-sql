...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Cafeteria Campus, garantizando la integridad de los datos.

## Entidades principales

| Entidad | Atributos principales |
| --- | --- |
| productos | id, nombre/codigo, atributos de negocio |
| ventas | id, nombre/codigo, atributos de negocio |

## Relacion

Una venta se asocia a UN producto de la cafeteria.
