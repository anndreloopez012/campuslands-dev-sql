...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Academia Kickboxing, garantizando la integridad de los datos.

## Entidades principales

| Entidad | Atributos principales |
| --- | --- |
| planes | id, nombre/codigo, atributos de negocio |
| alumnos | id, nombre/codigo, atributos de negocio |
| inscripciones | id, nombre/codigo, atributos de negocio |

## Relacion

Una inscripcion relaciona UN alumno con UN plan de entrenamiento.
