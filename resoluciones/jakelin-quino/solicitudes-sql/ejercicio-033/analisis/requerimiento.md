...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Viajes Paracaidismo, garantizando la integridad de los datos.
...
| saltos | id, nombre/codigo, atributos de negocio |
| reservas | id, nombre/codigo, atributos de negocio |

## Relacion

Una reserva asocia UN cliente a UNA modalidad de salto.
