...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Clanes Shooter, garantizando la integridad de los datos.

## Entidades principales

| Entidad | Atributos principales |
| --- | --- |
| clanes | id, nombre/codigo, atributos de negocio |
| jugadores | id, nombre/codigo, atributos de negocio |
| guerras | id, nombre/codigo, atributos de negocio |

## Relacion

Un jugador pertenece a UN clan. Una guerra enfrenta DOS clanes.
