...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Estudio Animacion 3D, garantizando la integridad de los datos.
...
| proyectos | id, nombre/codigo, atributos de negocio |
| renders | id, nombre/codigo, atributos de negocio |

## Relacion

Un proyecto pertenece a UN cliente. Un render pertenece a UN proyecto.
