...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Hotel Gamers, garantizando la integridad de los datos.

## Entidades principales

| Entidad | Atributos principales |
| --- | --- |
| huespedes | id, nombre/codigo, atributos de negocio |
| habitaciones | id, nombre/codigo, atributos de negocio |
| reservas | id, nombre/codigo, atributos de negocio |

## Relacion

Una reserva vincula UN huesped con UNA habitacion gaming.
