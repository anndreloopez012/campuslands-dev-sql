...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Taller de Motos, garantizando la integridad de los datos.
...
| motos | id, nombre/codigo, atributos de negocio |
| servicios | id, nombre/codigo, atributos de negocio |

## Relacion

Una moto pertenece a UN cliente. Un servicio pertenece a UNA moto.
