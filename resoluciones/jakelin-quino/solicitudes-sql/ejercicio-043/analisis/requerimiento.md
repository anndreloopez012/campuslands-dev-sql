...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Escuela de Dibujo, garantizando la integridad de los datos.

## Entidades principales

| Entidad | Atributos principales |
| --- | --- |
| profesores | id, nombre/codigo, atributos de negocio |
| cursos | id, nombre/codigo, atributos de negocio |
| inscripciones | id, nombre/codigo, atributos de negocio |

## Relacion

Un curso es dictado por UN profesor. Una inscripcion une UN alumno a UN curso.
