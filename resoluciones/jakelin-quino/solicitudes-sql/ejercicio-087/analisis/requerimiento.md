...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Club Futbol Sala, garantizando la integridad de los datos.
...
| partidos | id, nombre/codigo, atributos de negocio |

## Relacion

Un jugador pertenece a UN equipo. Un partido cruza DOS equipos.
