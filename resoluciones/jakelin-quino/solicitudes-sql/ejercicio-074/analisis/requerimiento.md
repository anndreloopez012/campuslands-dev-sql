...
Se construira un modelo con tablas bien definidas para registrar las entidades clave de Liga Videojuego Futbol, garantizando la integridad de los datos.
...
| clubes | id, nombre/codigo, atributos de negocio |
| jornadas | id, nombre/codigo, atributos de negocio |

## Relacion

Un club es administrado por UN usuario. Una jornada enfrenta DOS clubes.
