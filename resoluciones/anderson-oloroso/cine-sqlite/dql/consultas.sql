...
SELECT nombre_pelicula, duracion FROM peliculas;
...
SELECT * FROM peliculas ORDER BY nombre_pelicula;
...
SELECT * FROM funciones WHERE fecha > '2024-07-01';

-- 10. Contar cuantas funciones existen para cada sala utilizando GROUP BY.
SELECT sala, COUNT(*) AS total_funciones FROM funciones GROUP BY sala;
