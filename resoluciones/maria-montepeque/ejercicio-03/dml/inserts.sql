...
-- Datos base: 5 autores, 5 campers, 6 libros, 10 prestamos
...
INSERT INTO campers (nombre, correo, ficha) VALUES
    ('Diego Morales', 'diego.morales@campus.com', 'F-101'),
...
INSERT INTO libros (id_autor, titulo, genero, anio_publicacion, stock) VALUES
    (1, 'Clean Code', 'Programacion', 2008, 4),
...
INSERT INTO prestamos (id_camper, id_libro, fecha_prestamo, fecha_devolucion, estado) VALUES
    (1, 1, '2026-07-01', '2026-07-10', 'devuelto'),
