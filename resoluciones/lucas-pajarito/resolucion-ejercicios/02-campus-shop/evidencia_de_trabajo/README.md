...
Disenar e implementar una base de datos relacional en SQLite para un contexto de tienda de tecnologia. El ejercicio se enfoca en inventario y ventas de productos.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente productos, categorias, clientes y ventas, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-02/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-02/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-02
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/02-campus-shop/plantilla resoluciones/apellido-nombre/ejercicio-02
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 02`
