...
INSERT INTO proveedores (nombre, telefono) 
    VALUES ('Distribuidora Andina', '5552001'),
    ('Ciclo Import', '5552002'),
    ('Bikes Express', '5552003'),
    ('Rueda Libre SA', '5552004'),
    ('Pedal Group', '5552005');

INSERT INTO bicicletas (id_marca, modelo, tipo, precio, stock) 
    VALUES (1, 'Marlin 7', 'montana', 950.00, 10),
...
INSERT INTO movimientos_inventario (id_bicicleta, id_proveedor, tipo_movimiento, cantidad, fecha_movimiento) 
    VALUES (1, 1, 'entrada', 10, '2026-07-01'),
