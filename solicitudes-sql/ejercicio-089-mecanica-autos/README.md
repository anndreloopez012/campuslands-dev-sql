# Ejercicio 089: Solicitud de cliente - Mecanica de Autos
...
Un taller automotriz controla diagnosticos, reparaciones, repuestos y garantias.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-089/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
