# Ejercicio 049: Solicitud de cliente - Liga Videojuego Futbol
...
Una liga de videojuegos de futbol registra usuarios, clubes, jornadas y goles.

Solicitud recibida:

> El cliente necesita guardar historico porque en auditorias le preguntan que paso y cuando paso.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-049/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
