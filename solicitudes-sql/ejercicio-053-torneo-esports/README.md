# Ejercicio 053: Solicitud de cliente - Torneo Esports
...
Una organizacion de esports registra equipos, jugadores, partidas y puntos.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-053/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
