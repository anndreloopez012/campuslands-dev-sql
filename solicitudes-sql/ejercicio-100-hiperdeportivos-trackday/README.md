# Ejercicio 100: Solicitud de cliente - Track Day Hiperdeportivos
...
Una pista organiza sesiones con vehiculos hiperdeportivos, pilotos y tiempos.

Solicitud recibida:

> El cliente quiere detectar errores: registros repetidos, relaciones invalidas o valores fuera de rango.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-100/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
...
sqlite3 ejercicio-100.db < dml/operaciones.sql
