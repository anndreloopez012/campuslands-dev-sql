# Ejercicio 088: Solicitud de cliente - Clinica de Tatuajes
...
Un estudio de tatuajes agenda sesiones, artistas, estilos y pagos.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-088/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
