# Ejercicio 087: Solicitud de cliente - Club Futbol Sala
...
Un club registra jugadores, partidos, goles, tarjetas y posiciones.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-087/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
