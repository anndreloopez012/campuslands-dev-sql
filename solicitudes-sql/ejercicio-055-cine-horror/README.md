# Ejercicio 055: Solicitud de cliente - Cine Horror Nights
...
Un cine organiza funciones de peliculas de miedo, salas y ventas de boletos.
...
3 a 4 tablas, reglas de negocio, UPDATE y DELETE con criterios seguros.

Habilidades principales:

- validar restricciones
- aplicar UPDATE con WHERE
- aplicar DELETE controlado
- reportar cambios
...
- Minimo `4` tablas coherentes con el caso.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-055/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
