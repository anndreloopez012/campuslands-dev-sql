# Ejercicio 052: Solicitud de cliente - Taller de Motos
...
Un taller de motos recibe servicios, repuestos y mecanicos por orden de trabajo.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-052/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
