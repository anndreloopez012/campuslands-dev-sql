# Ejercicio 097: Solicitud de cliente - Liga MOBA
...
Una liga MOBA controla equipos, heroes usados, bans, partidas y estadisticas.

Solicitud recibida:

> El cliente pide que el sistema permita corregir estados sin borrar informacion importante.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-097/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
...
```bash
sqlite3 ejercicio-097.db < ddl/schema.sql
sqlite3 ejercicio-097.db < dml/inserts.sql
sqlite3 ejercicio-097.db < dml/operaciones.sql
sqlite3 ejercicio-097.db < dql/consultas.sql
```
