# Ejercicio 091: Solicitud de cliente - Hotel Gamers
...
> El cliente dice que hoy todo se maneja en hojas de calculo y que varias personas duplican datos sin darse cuenta.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-091/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
...
```bash
sqlite3 ejercicio-091.db < ddl/schema.sql
sqlite3 ejercicio-091.db < dml/inserts.sql
sqlite3 ejercicio-091.db < dml/operaciones.sql
sqlite3 ejercicio-091.db < dql/consultas.sql
```
