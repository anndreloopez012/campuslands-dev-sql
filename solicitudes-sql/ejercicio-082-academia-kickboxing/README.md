# Ejercicio 082: Solicitud de cliente - Academia Kickboxing
...
Una academia gestiona alumnos, planes, entrenadores y asistencias.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-082/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
