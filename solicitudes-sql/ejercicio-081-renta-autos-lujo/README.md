# Ejercicio 081: Solicitud de cliente - Renta Autos de Lujo
...
Una empresa alquila autos deportivos y necesita controlar reservas, clientes y pagos.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-081/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
