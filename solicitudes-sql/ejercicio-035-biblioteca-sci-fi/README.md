# Ejercicio 035: Solicitud de cliente - Biblioteca Sci-Fi
...
2 a 3 tablas con relaciones uno a muchos, claves foraneas e inserts relacionados.

Habilidades principales:

- definir relaciones
- usar FOREIGN KEY
- crear consultas con JOIN
- actualizar estados
...
- Minimo `3` tablas coherentes con el caso.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-035/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
