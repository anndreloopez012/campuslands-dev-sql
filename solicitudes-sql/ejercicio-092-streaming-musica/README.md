# Ejercicio 092: Solicitud de cliente - Streaming Musica
...
Una plataforma musical necesita playlists, artistas, canciones y reproducciones.

Solicitud recibida:

> El cliente pide saber quien compro, que compro, cuando ocurrio y cuanto dinero representa cada movimiento.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-092/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
...
```bash
sqlite3 ejercicio-092.db < ddl/schema.sql
sqlite3 ejercicio-092.db < dml/inserts.sql
sqlite3 ejercicio-092.db < dml/operaciones.sql
sqlite3 ejercicio-092.db < dql/consultas.sql
```
