# Ejercicio 094: Solicitud de cliente - Diseno 3D Arquitectura
...
Un estudio registra clientes, renders, planos, revisiones y entregas.

Solicitud recibida:

> El cliente necesita un reporte rapido para tomar decisiones al final de cada semana.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-094/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
...
```bash
sqlite3 ejercicio-094.db < ddl/schema.sql
sqlite3 ejercicio-094.db < dml/inserts.sql
sqlite3 ejercicio-094.db < dml/operaciones.sql
sqlite3 ejercicio-094.db < dql/consultas.sql
```
