# Ejercicio 083: Solicitud de cliente - Viajes y Paracaidismo
...
Una agencia vende experiencias de viaje, turismo y saltos en paracaidas.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-083/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
