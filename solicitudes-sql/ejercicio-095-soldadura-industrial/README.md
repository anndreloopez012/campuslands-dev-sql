# Ejercicio 095: Solicitud de cliente - Soldadura Industrial
...
Un taller controla ordenes, materiales, tecnicos, inspecciones y costos.

Solicitud recibida:

> El cliente no sabe hablar en terminos de tablas: solo describe su operacion diaria y espera que usted la traduzca a SQL.
...
Modelo mas completo, decisiones de diseno, auditoria, vistas y analisis de casos ambiguos.

Habilidades principales:

- interpretar ambiguedad
- normalizar datos
- crear vistas
...
- vista SQL
- documentacion de decisiones de modelado
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-095/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
...
```bash
sqlite3 ejercicio-095.db < ddl/schema.sql
sqlite3 ejercicio-095.db < dml/inserts.sql
sqlite3 ejercicio-095.db < dml/operaciones.sql
sqlite3 ejercicio-095.db < dql/consultas.sql
```
