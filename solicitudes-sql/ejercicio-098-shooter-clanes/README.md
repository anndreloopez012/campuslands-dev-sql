# Ejercicio 098: Solicitud de cliente - Clanes Shooter
...
Una plataforma de shooter administra clanes, scrims, mapas y resultados.

Solicitud recibida:

> El cliente quiere consultar rankings, totales y casos pendientes desde la base de datos.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-098/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
...
```bash
sqlite3 ejercicio-098.db < ddl/schema.sql
sqlite3 ejercicio-098.db < dml/inserts.sql
sqlite3 ejercicio-098.db < dml/operaciones.sql
sqlite3 ejercicio-098.db < dql/consultas.sql
```
