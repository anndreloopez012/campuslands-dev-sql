# Ejercicio 085: Solicitud de cliente - Biblioteca Sci-Fi
...
Una biblioteca especializada presta libros de ciencia ficcion y controla devoluciones.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-085/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
