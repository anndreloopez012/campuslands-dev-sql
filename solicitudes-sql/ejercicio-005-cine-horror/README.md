...
1 a 2 tablas, atributos claros, llaves primarias, datos base y SELECT simples.
...
- Minimo `2` tablas coherentes con el caso.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-005/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
