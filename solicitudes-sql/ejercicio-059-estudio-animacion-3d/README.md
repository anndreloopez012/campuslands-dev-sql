# Ejercicio 059: Solicitud de cliente - Estudio Animacion 3D
...
Un estudio maneja proyectos de animacion 3D, artistas, entregas y estados.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-059/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
