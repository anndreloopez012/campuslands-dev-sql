# Ejercicio 090: Solicitud de cliente - Laboratorio Quimico
...
Un laboratorio registra formulas, muestras, reactivos y resultados.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-090/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
