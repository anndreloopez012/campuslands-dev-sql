# Ejercicio 093: Solicitud de cliente - Escuela de Dibujo
...
Una escuela creativa administra cursos, alumnos, entregas y evaluaciones.

Solicitud recibida:

> El cliente quiere evitar registros incompletos porque despues no puede hacer reportes confiables.
...
```text
resoluciones/nombre-apellido/solicitudes-sql/ejercicio-093/
├── README.md
├── analisis/
│   └── requerimiento.md
├── diagramas/
...
```bash
sqlite3 ejercicio-093.db < ddl/schema.sql
sqlite3 ejercicio-093.db < dml/inserts.sql
sqlite3 ejercicio-093.db < dml/operaciones.sql
sqlite3 ejercicio-093.db < dql/consultas.sql
```
