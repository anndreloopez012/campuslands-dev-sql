...
Disenar e implementar una base de datos relacional en SQLite para un contexto de biblioteca con reportes. El ejercicio se enfoca en consultas con joins y agrupaciones.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente sedes, libros, usuarios y prestamos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-25/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-25/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-25
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/25-reportes-biblioteca/plantilla resoluciones/apellido-nombre/ejercicio-25
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 25`
