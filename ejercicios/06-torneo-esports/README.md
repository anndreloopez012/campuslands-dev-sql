...
Disenar e implementar una base de datos relacional en SQLite para un contexto de torneo de videojuegos. El ejercicio se enfoca en registro de partidas y marcadores.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente equipos, jugadores, partidas y resultados, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-06/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-06/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-06
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/06-torneo-esports/plantilla resoluciones/apellido-nombre/ejercicio-06
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 06`
