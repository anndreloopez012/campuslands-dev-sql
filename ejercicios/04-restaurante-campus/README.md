...
Disenar e implementar una base de datos relacional en SQLite para un contexto de restaurante. El ejercicio se enfoca en pedidos y consumo por mesa.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente mesas, platos, pedidos y detalles, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-04/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-04/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-04
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/04-restaurante-campus/plantilla resoluciones/apellido-nombre/ejercicio-04
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 04`
