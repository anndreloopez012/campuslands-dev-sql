...
Disenar e implementar una base de datos relacional en SQLite para un contexto de sistema de reservas. El ejercicio se enfoca en transacciones y consistencia.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente usuarios, recursos, reservas y pagos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-29/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-29/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-29
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/29-transacciones-reservas/plantilla resoluciones/apellido-nombre/ejercicio-29
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 29`
