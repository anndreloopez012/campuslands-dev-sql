...
Disenar e implementar una base de datos relacional en SQLite para un contexto de empresa de transporte. El ejercicio se enfoca en viajes programados y capacidad.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente rutas, buses, conductores y viajes, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-11/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-11/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-11
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/11-transporte-rutas/plantilla resoluciones/apellido-nombre/ejercicio-11
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 11`
