...
Disenar e implementar una base de datos relacional en SQLite para un contexto de red social educativa. El ejercicio se enfoca en interacciones entre usuarios.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente usuarios, publicaciones, comentarios y reacciones, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-17/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-17/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-17
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/17-red-social-campus/plantilla resoluciones/apellido-nombre/ejercicio-17
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 17`
