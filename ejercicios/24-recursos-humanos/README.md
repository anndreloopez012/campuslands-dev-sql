...
Disenar e implementar una base de datos relacional en SQLite para un contexto de area de talento humano. El ejercicio se enfoca en contratos y nomina basica.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente departamentos, empleados, cargos y contratos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-24/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-24/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-24
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/24-recursos-humanos/plantilla resoluciones/apellido-nombre/ejercicio-24
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 24`
