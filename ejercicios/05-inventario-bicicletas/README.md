...
Disenar e implementar una base de datos relacional en SQLite para un contexto de tienda de bicicletas. El ejercicio se enfoca en control de entradas y salidas de inventario.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente bicicletas, marcas, proveedores y movimientos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-05/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-05/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-05
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/05-inventario-bicicletas/plantilla resoluciones/apellido-nombre/ejercicio-05
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 05`
