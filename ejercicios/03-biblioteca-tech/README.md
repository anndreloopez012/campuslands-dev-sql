...
Disenar e implementar una base de datos relacional en SQLite para un contexto de biblioteca academica. El ejercicio se enfoca en prestamos y devoluciones de libros.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente libros, autores, campers y prestamos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-03/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-03/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-03
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/03-biblioteca-tech/plantilla resoluciones/apellido-nombre/ejercicio-03
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 03`
