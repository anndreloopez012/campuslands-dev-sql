...
Disenar e implementar una base de datos relacional en SQLite para un contexto de servicio de delivery. El ejercicio se enfoca en pedidos, estados y asignaciones.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente clientes, restaurantes, repartidores y pedidos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-22/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-22/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-22
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/22-pedidos-delivery/plantilla resoluciones/apellido-nombre/ejercicio-22
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 22`
