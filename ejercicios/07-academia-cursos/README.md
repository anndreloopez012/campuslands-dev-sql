...
Disenar e implementar una base de datos relacional en SQLite para un contexto de academia de programacion. El ejercicio se enfoca en inscripciones y seguimiento academico.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente cursos, instructores, estudiantes y matriculas, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-07/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-07/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-07
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/07-academia-cursos/plantilla resoluciones/apellido-nombre/ejercicio-07
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 07`
