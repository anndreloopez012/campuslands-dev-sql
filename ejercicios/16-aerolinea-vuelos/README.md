...
Disenar e implementar una base de datos relacional en SQLite para un contexto de aerolinea. El ejercicio se enfoca en vuelos y reservas de pasajeros.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente aeropuertos, aviones, vuelos y reservas, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-16/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-16/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-16
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/16-aerolinea-vuelos/plantilla resoluciones/apellido-nombre/ejercicio-16
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 16`
