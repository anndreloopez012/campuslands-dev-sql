...
Disenar e implementar una base de datos relacional en SQLite para un contexto de banco digital. El ejercicio se enfoca en movimientos y saldos de cuentas.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente clientes, cuentas, transacciones y tarjetas, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-13/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-13/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-13
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/13-banco-cuentas/plantilla resoluciones/apellido-nombre/ejercicio-13
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 13`
