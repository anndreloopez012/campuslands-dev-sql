...
Disenar e implementar una base de datos relacional en SQLite para un contexto de empresa logistica. El ejercicio se enfoca en seguimiento de envios.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente clientes, paquetes, rutas y envios, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-21/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-21/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-21
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/21-logistica-envios/plantilla resoluciones/apellido-nombre/ejercicio-21
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 21`
