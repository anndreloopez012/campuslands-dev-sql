...
Disenar e implementar una base de datos relacional en SQLite para un contexto de clinica medica. El ejercicio se enfoca en agenda de citas y disponibilidad.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente pacientes, medicos, consultorios y citas, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-08/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-08/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-08
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/08-clinica-citas/plantilla resoluciones/apellido-nombre/ejercicio-08
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 08`
