...
Disenar e implementar una base de datos relacional en SQLite para un contexto de sistema de ventas. El ejercicio se enfoca en vistas SQL para reportes.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente clientes, vendedores, ventas y pagos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-28/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-28/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-28
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/28-vistas-reportes/plantilla resoluciones/apellido-nombre/ejercicio-28
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 28`
