...
Disenar e implementar una base de datos relacional en SQLite para un contexto de taller mecanico. El ejercicio se enfoca en servicios realizados a motos.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente clientes, motos, servicios y ordenes, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-15/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-15/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-15
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/15-taller-motos/plantilla resoluciones/apellido-nombre/ejercicio-15
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 15`
