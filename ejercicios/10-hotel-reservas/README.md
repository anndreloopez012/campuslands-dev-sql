...
Disenar e implementar una base de datos relacional en SQLite para un contexto de hotel. El ejercicio se enfoca en reservas y ocupacion de habitaciones.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente huespedes, habitaciones, reservas y pagos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-10/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-10/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-10
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/10-hotel-reservas/plantilla resoluciones/apellido-nombre/ejercicio-10
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 10`
