...
Disenar e implementar una base de datos relacional en SQLite para un contexto de tienda con datos repetidos. El ejercicio se enfoca en normalizacion hasta tercera forma normal.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente clientes, productos, categorias y compras, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-26/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-26/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-26
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/26-normalizacion-tienda/plantilla resoluciones/apellido-nombre/ejercicio-26
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 26`
