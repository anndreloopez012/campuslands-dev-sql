...
Disenar e implementar una base de datos relacional en SQLite para un contexto de plataforma de eventos. El ejercicio se enfoca en venta y control de boletos.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente eventos, lugares, asistentes y boletos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-20/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-20/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-20
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/20-eventos-boletos/plantilla resoluciones/apellido-nombre/ejercicio-20
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 20`
