...
Disenar e implementar una base de datos relacional en SQLite para un contexto de farmacia. El ejercicio se enfoca en stock, compras y ventas de medicamentos.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente medicamentos, laboratorios, compras y ventas, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-18/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-18/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-18
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/18-farmacia-inventario/plantilla resoluciones/apellido-nombre/ejercicio-18
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 18`
