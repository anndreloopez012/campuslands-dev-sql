...
Disenar e implementar una base de datos relacional en SQLite para un contexto de marketplace. El ejercicio se enfoca en ordenes de compra y ventas por vendedor.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente vendedores, productos, compradores y ordenes, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-14/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-14/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-14
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/14-marketplace-campus/plantilla resoluciones/apellido-nombre/ejercicio-14
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 14`
