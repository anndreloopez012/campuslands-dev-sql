...
Disenar e implementar una base de datos relacional en SQLite para un contexto de catalogo de cursos. El ejercicio se enfoca en busquedas eficientes e indices.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente categorias, cursos, instructores e inscripciones, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-27/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-27/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-27
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/27-indices-busquedas/plantilla resoluciones/apellido-nombre/ejercicio-27
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 27`
