...
Disenar e implementar una base de datos relacional en SQLite para un contexto de plataforma de musica. El ejercicio se enfoca en catalogo musical y reproducciones.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente artistas, albumes, canciones y reproducciones, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-12/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-12/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-12
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/12-streaming-musica/plantilla resoluciones/apellido-nombre/ejercicio-12
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 12`
