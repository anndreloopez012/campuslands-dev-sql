...
Disenar e implementar una base de datos relacional en SQLite para un contexto de sistema de facturacion. El ejercicio se enfoca en facturas, subtotales e impuestos.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente clientes, facturas, productos y detalles, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-23/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-23/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-23
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/23-facturacion-simple/plantilla resoluciones/apellido-nombre/ejercicio-23
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 23`
