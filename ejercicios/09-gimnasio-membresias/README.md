...
Disenar e implementar una base de datos relacional en SQLite para un contexto de gimnasio. El ejercicio se enfoca en membresias activas y pagos.

## Contexto

Una organizacion necesita dejar de manejar informacion en hojas sueltas y pasar a una base de datos relacional. Actualmente registra manualmente clientes, planes, membresias y pagos, lo que provoca duplicidad, errores de captura y dificultad para generar reportes.
...
```text
resoluciones/apellido-nombre/ejercicio-09/
├── README.md
├── diagramas/
│   └── diagrama-er.png
├── ddl/
...
5. Copie la carpeta `plantilla/` dentro de `resoluciones/apellido-nombre/ejercicio-09/`.
...
git switch dev
git pull origin dev
git switch -c alumno/apellido-nombre/ejercicio-09
mkdir -p resoluciones/apellido-nombre
cp -R ejercicios/09-gimnasio-membresias/plantilla resoluciones/apellido-nombre/ejercicio-09
```
...
- Titulo claro, por ejemplo: `feat(sql): resolver ejercicio 09`
